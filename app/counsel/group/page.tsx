    ...
    <div className="flex h-full w-full flex-col p-8">
      ...
      <span>
        ...
        <div>
          ...
          <div className="mb-4 mt-8 w-[100%] font-bold text-[#444]">자아성장</div>
          ...
          <div className="mb-4 mt-8 w-[100%] font-bold text-[#444]">이성관계 향상</div>
          <div className="mb-4 ml-12 flex flex-row">
            <div>
              <div className="text-[#878787]">
          ...
          <div className="mb-4 mt-8 w-[100%] font-bold text-[#444]">진로탐색</div>
          <div className="mb-4 ml-12 flex flex-row">
            <div>
              <div className="text-[#878787]">
          ...
          <div className="mb-4 mt-8 w-[100%] font-bold text-[#444]">대인관계 향상</div>
          <div className="mb-4 ml-12 flex flex-row">
            <div>
              <div className="text-[#878787]">
          ...
          <div className="mb-4 mt-8 w-[100%] font-bold text-[#444]">자기표현 및 주장력 향상</div>
          <div className="mb-4 ml-12 flex flex-row">
            <div>
              <div className="text-[#878787]">
