      ...
      <span>
        <div className=" w-[100%] bg-white p-4 " data-aos="fade-right">
          <div className="text-lg text-[#5f727f]">
            자신과 유사한 관심사를 가진 여러 사람이 모여 함께 이야기를 공유하고
            상호작용 하는 과정 속에서 나와 타인의 성장을 도모합니다. 대략 10명
            내외의 참가자들이 1~2명의 전문상담자의 진행에 따라 진행됩니다.
          </div>
        </div>
        <hr className="my-8" />
        <div className="mb-20">
              ...
              <TableBody className="">
                <TableRow className="hover:cursor-pointer hover:bg-[#eeeeee]">
                  ...
                  <TableCell className="h-[70px]  w-48 text-center">
                    우울, 의욕저하, 불안, 죄책감, 자살충동 등 여러가지 정서적
                    스트레스 상태를 파악
                  </TableCell>
                  <TableCell className="h-[70px] w-12 text-center">
                    90분
                  </TableCell>
            ...
            <Table stickyHeader className="">
              ...
              <TableBody className="">
                <TableRow className="hover:cursor-pointer hover:bg-[#eeeeee]">
                  ...
                  <TableCell className="h-[70px]  w-48 text-center">
                    자신의 타고난 또는 익숙한 심리적 경향성을 살펴보고 자신과
                    타인에 대한 이해를 도움
                  </TableCell>
                  <TableCell className="h-[70px] w-12 text-center">
                    30분
                ...
                <TableRow className="hover:cursor-pointer hover:bg-[#eeeeee]">
                  ...
                  <TableCell className="h-[70px] w-48 text-center">
                    개인의 사고방식, 감정양식, 행동패턴, 대인관계 양상, 선호
                    경향 등을 폭 넓고 정교하게 이해를 도움
                  </TableCell>
                  <TableCell className="h-[70px] w-12 text-center">
                    30분
                  </TableCell>
