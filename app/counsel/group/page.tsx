...
const Group: NextPage = () => {
  ...
  return (
    <div className="flex h-full w-full flex-col p-8">
      <div className="border-b-2 pb-8 text-3xl font-bold" data-aos="fade-right">
        집단상담
      </div>
      <span>
        <div className=" w-[100%] bg-white p-4" data-aos="fade-left">
        ...
        <div>
          ...
          <div className="mb-4 mt-8 w-[100%] font-bold text-[#444]" data-aos="fade-right">
            자아성장
          </div>
