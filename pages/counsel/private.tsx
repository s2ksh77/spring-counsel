    ...
    <div className="flex h-full w-full flex-col p-8 sm:w-full">
      ...
      <span>
        <div className=" w-[100%] bg-white p-4 ">
          <div className="mb-4 text-xl font-bold">개인 상담이란 ? </div>
          <div className="font-xl text-md p-2">
        ...
        <hr className="my-8" />
        <div>
          <span className="text-xl font-bold">개인상담이 가능한 영역</span>
          <div className="flex flex-row">
            <div className="m-4 flex h-24 w-24 items-center justify-center rounded-full border-[2px] p-4">
              성격
            </div>
            <div className="m-4 flex h-24 w-24 items-center justify-center rounded-full border-[2px] p-[0.8rem]">
              대인관계
            </div>
            <div className="m-4 flex h-24 w-24 items-center justify-center rounded-full border-[2px] p-4">
              정서
        ...
        <div>
          ...
          <div className="mt-8 mb-4 w-[90px] font-bold text-[#444]">대인관계</div>
          <div className="ml-12 mb-4 flex flex-row">
            <div>
          ...
          <div className="mt-8 mb-4 w-[90px] font-bold text-[#444]">진로적성</div>
          <div className="ml-12 mb-4 flex flex-row">
            <div>
          ...
          <div className="mt-8 mb-4 w-[90px] font-bold text-[#444]">정서</div>
          <div className="ml-12 mb-4 flex flex-row">
            <div>
              <div className="text-[#878787]">
          ...
          <div className="mt-8 mb-4 w-[90px] font-bold text-[#444]">성격</div>
          <div className="ml-12 mb-4 flex flex-row">
            <div>
