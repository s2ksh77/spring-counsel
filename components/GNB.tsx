      ...
      <div className="flex flex-col sm:w-full sm:justify-between md:w-full md:justify-between lg:w-full xl:w-full">
        <div className="flex items-center justify-between px-16">
          ...
          <div className="flex gap-4">
            <div className="flex min-w-[90px] cursor-pointer flex-col items-center rounded-full bg-[#a9ce8e] p-4">
              <AssignmentOutlinedIcon className="h-8 w-8 text-white" />
              <Link href="/proposal/reservationForm">
                <span className="text-white">상담신청</span>
              </Link>
            </div>
            <div
              onClick={() =>
            ...
            >
              <div className="flex min-w-[90px] cursor-pointer flex-col items-center rounded-full bg-[#a9ce8e] p-4 ">
                <KakaoSVG />
                <span className="text-white">카카오톡</span>
              </div>
            </div>
            <div
              onClick={handleLogin}
              className="flex min-w-[90px] cursor-pointer flex-col items-center rounded-full bg-[#a9ce8e] p-4"
            >
              <VpnKeyOutlinedIcon className="h-8 w-8 text-white" />
              <button>
                <span className="text-white">{isLogin ? '로그아웃' : '로그인'}</span>
              </button>
            </div>
          </div>
        </div>
        <div className="flex bg-white">
          <div className="flex flex-1">
            <div id="menu" className="flex w-full flex-col justify-around sm:!hidden md:!hidden">
              <div id="menu-title" className="flex">
                ...
                {isLogin ? (
                  <div className="menu-item flex justify-start">
                    <div className="py-[2rem] text-center">
